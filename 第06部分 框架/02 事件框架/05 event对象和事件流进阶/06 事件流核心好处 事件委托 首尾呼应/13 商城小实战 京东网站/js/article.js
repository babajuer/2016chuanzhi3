 ...
 */
        ...
        function(){
            $("#spec-list img").mouseenter(function(){
                $("#spec-list img").removeClass('hover');                     
                $(this).addClass('hover');
                $("#big img").hide().eq($("#spec-list img").index(this)).show(); 
                $("#spec-n1 img").hide().eq($("#spec-list img").index(this)).show(); 
            ...
            var fl = $id('fllow');
            var bigpic = $id('big').children[$("#spec-list img").index(this)];
